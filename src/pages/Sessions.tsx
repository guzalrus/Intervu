    ...
    <div className="min-h-screen bg-[#f0f4f8] text-[#0c1f33]">
      ...
      <aside className="hidden md:flex h-screen w-64 fixed left-0 top-0 bg-white border-r border-[#c3c6ce] flex-col py-8 px-4 z-40">
        ...
        <nav className="flex-grow space-y-2">
          <Link to="/" className="flex items-center gap-3 py-3 px-4 rounded-lg font-semibold transition-colors text-[#43474d] hover:bg-[#eff4ff]">
      ...
      <main className="md:ml-64 min-h-screen px-4 md:px-12 py-12 pb-24 md:pb-12 max-w-[900px] mx-auto">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
            <span className="material-symbols-outlined text-5xl text-[#73777e]">video_call</span>
          ...
          <div className="flex flex-col gap-4">
            {sessions.map((session) => (
              <button
                ...
                className="w-full text-left bg-white border border-[#c3c6ce] rounded-xl px-6 py-5 hover:border-[#486177] hover:shadow-sm transition-all"
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 text-[#486177]">
